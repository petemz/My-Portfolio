import CredlyBadge from "../Components/Icons"
...
const About = () => {
	...
	return ( 
		<div className="bg-inherit md:pl-0 xl:pl-6 pl-40 2xl:pl-24 pb-2 flex justify-between h-full w-full relative">
			...
			<div className="pt-4 xl:pt-28 w-[750px] xl:w-full h-full overflow-y-auto custom-scrollbar flex flex-col items-ce">
				<div className="mb-10">
					<p className="text-lg">Hi! I'm <span className=" font-semibold">Peter Emmies</span>, a student of the University of Lagos, department of Computer Science. As a frontend web developer, I am dedicated to creating functional, interactive and sleek web applications that meet the needs of clients and users alike. With expertise in JavaScript, Typescript, ReactJS, VueJS, and other technologies.
					...
					In my free time, I play chess and listen to music.</p> 
				</div>
