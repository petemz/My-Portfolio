...
const Projects = () => {
    ...
    const projects = [
        ...
        {name:"Yoshiki Okamura Clone", languages:"React + Tailwind CSS", description:"A clone of the Yoshiki Okamura Art website", link:"https://yoshikiokamura-clone.vercel.app"},
